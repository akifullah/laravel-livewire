            ...
            <div class="row">
                <div class="col-8 mx-auto text-center">
                    ...
                    <ul class="list-inline breadcrumbs text-capitalize" style="font-weight:500">
                        <li class="list-inline-item"><a href="{{route("contact")}}" wire:navigate>Home</a>
                        </li>
                            ...
                            <div class="col-lg-6">
                                <div class="contact-form">
                                    <form wire:submit='submit'>
                                        ...
                                        <div class="form-group mb-4 pb-2">
                                            <label for="message" class="form-label">Write
                                                Message</label>
                                            <textarea class="form-control shadow-none" name="message" id="message"
                                                wire:model='message' rows="3"></textarea>
                                        </div>
